...
[рис. 3](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/3.png)

![Файл ks.cfg с параметрами автоматической установки Rocky Linux](image/4.png){#fig-4 width=70%}
[рис. 4](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/4.png)
...
[рис. 5](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/5.png)

![Структура каталога provision с подкаталогами default, server и client](image/6.png){#fig-6 width=70%}
[рис. 6](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/6.png)
...
[рис. 7](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/7.png)
...
[рис. 8](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/8.png)


![Скрипт 01-hostname.sh для установки доменного имени хоста](image/9.png){#fig-9 width=70%}
[рис. 9](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/9.png)

![Скрипт 02-forward.sh для включения IP-forwarding и masquerading](image/10.png){#fig-10 width=70%}
[рис. 10](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/10.png)

![Скрипт 01-routing.sh для настройки маршрутизации клиента](image/11.png){#fig-11 width=70%}
[рис. 11](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/11.png)
...
[рис. 12](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/12.png)

![Сформированный box-файл vagrant-virtualbox-rocky-9-x86\_64.box](image/13.png){#fig-13 width=70%}
[рис. 13](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/13.png)
...
[рис. 14](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/14.png)

![Запуск виртуальной машины server через vagrant up](image/15.png){#fig-15 width=70%}
[рис. 15](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/15.png)
...
[рис. 16](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/16.png)

![Графический вход в систему на виртуальной машине server](image/17.png){#fig-17 width=70%}
[рис. 17](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/17.png)


Подключение к серверу выполнено командой `vagrant ssh server`, после ввода пароля осуществлён переход к пользователю `user` командой `su - user` и последующий выход из сеанса ([рис. @fig-18]). Аналогичные действия выполнены для клиента с использованием команды `vagrant ssh client` ([рис. @fig-18-1]).

![Подключение по SSH к server и переход к пользователю user](image/18.png){#fig-18 width=70%}
[рис. 18](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/18.png)

![Подключение по SSH к client и переход к пользователю user](image/18-1.png){#fig-18-1 width=70%}
[рис. 18-1](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/18-1.png)
...
[рис. 19](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/19.png)

# Внесение изменений в настройки внутреннего окружения виртуальной машины

В конфигурационном файле `Vagrantfile` перед разделом с описанием виртуальной машины server добавлены provisioning-блоки `common user` и `common hostname`, обеспечивающие выполнение скриптов `01-user.sh` и `01-hostname.sh` при загрузке ВМ ([рис. @fig-20]). Это гарантирует создание пользователя user и установку доменного имени вида `*.user.net`.

![Фрагмент Vagrantfile с блоками common user и common hostname](image/20.png){#fig-20 width=70%}
[рис. 20](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/20.png)

Для применения изменений выполнены команды `vagrant up server --provision` и `vagrant up client --provision`, в результате чего повторно запущены provisioning-сценарии и зафиксированы внутренние настройки виртуальных машин ([рис. @fig-21], [рис. @fig-22]). В процессе выполнения на сервере зафиксировано существование пользователя user, что подтверждает корректную работу скрипта создания пользователя.

![Повторный запуск user с ключом --provision](image/21.png){#fig-21 width=70%}
[рис. 21](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/21.png)

![Повторный запуск client с ключом --provision](image/22.png){#fig-22 width=70%}
[рис. 22](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/22.png)

После применения настроек выполнен вход в графическом интерфейсе под пользователем user на сервере и клиенте ([рис. @fig-23], [рис. @fig-23-1]). При подключении по SSH командой `vagrant ssh` выполнен переход к пользователю `user` через `su - user`, при этом приглашение терминала отображается в формате `user@server.usernet` и `user@client.user.net`, что подтверждает корректную настройку hostname и пользовательского окружения ([рис. @fig-24]).

![Графический вход под пользователем user на сервере](image/23.png){#fig-23 width=70%}
[рис. 23](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/23.png)


![Графический вход под пользователем user на клиенте](image/23-1.png){#fig-23-1 width=70%}
[рис. 23-1](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab01/report/image/23-1.png)

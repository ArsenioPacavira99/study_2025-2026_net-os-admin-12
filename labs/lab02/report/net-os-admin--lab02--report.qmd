...
На виртуальной машине server выполнен вход под пользователем user и переход в режим суперпользователя с помощью команды `sudo -i`, что подтверждается сменой приглашения командной строки на root ([рис. @fig-1]).

![Переход в режим суперпользователя sudo -i](image/1.png){#fig-1 width=70%}
[рис. 1](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/1.png)
...
[рис. 2](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/2.png)
...
[Нажмите здесь, чтобы открыть ссылку.](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/3.png)
## Конфигурирование кэширующего DNS-сервера

Проанализировано содержимое файла `/etc/resolv.conf`: указан поисковый домен user.net и заданы внешние DNS-серверы (172.249.0.7, 8.8.8.8, 8.8.4.4), что определяет порядок разрешения имён до изменения конфигурации ([рис. @fig-4]).

![Содержимое файла /etc/resolv.conf](image/4.png){#fig-4 width=70%}
[рис. 4](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/4.png)
...
[рис. 5](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/5.png)
...
[рис. 6](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/6.png)

![Содержимое файла named.localhost](image/7.png){#fig-7 width=70%}
[рис. 7]https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/7.png)

![Содержимое файла named.loopback](image/8.png){#fig-8 width=70%}
[рис. 8](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/8.png)
...
[рис. 9](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/9.png)
...
[рис. 10](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/10.png)
...
[рис. 11](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/11.png)
...
[рис. 12](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/12.png)
...
[рис. 13](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/13.png)

## Конфигурирование первичного DNS-сервера

На первом этапе выполнено копирование шаблона зон DNS `named.rfc1912.zones` в каталог `/etc/named` с последующим переименованием файла в `user.net`, после чего данный файл был подключён в конфигурации `/etc/named.conf` директивой `include "/etc/named/usernet";` ([рис. @fig-14]).

![Копирование и подключение файла зоны bahis.net в named.conf](image/14.png){#fig-14 width=70%}
[рис. 22](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/14.png)
...
![Определение прямой и обратной зон в файле user.net](image/16.png){#fig-16 width=70%}
[рис. 16](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/16.png)

После этого в каталоге `/var/named` созданы подкаталоги `master/fz` и `master/rz` для размещения файлов прямой и обратной зон. В каталог `master/fz` скопирован шаблон `named.localhost`, который был переименован в `user.net` ([рис. @fig-17]).

![Создание каталогов master/fz и master/rz и подготовка файла прямой зоны](image/17.png){#fig-17 width=70%}
[рис. 17](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/17.png)


Затем был отредактирован файл обратной зоны `/var/named/master/rz/192.168.1`: указана директива `$TTL 1D`, задана запись SOA с сервером `server.user.net.`, установлен серийный номер формата ГГГГММДДВВ, добавлена A-запись с адресом `192.168.1.1`, а также PTR-записи для соответствия IP-адреса имени `server.bahis.net.` и `ns.bahis.net.`; директива `$ORIGIN` установлена в `1.168.192.in-addr.arpa.` ([рис. @fig-18]).

![Настройка файла обратной DNS-зоны 192.168.1](image/18.png){#fig-18 width=70%}
[рис. 18](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/18.png)
...
[рис. 20](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/20.png)
...
[рис. 21](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/21.png)

Далее выполнена передача зоны командой `host -l user.net`. В выводе отображаются NS-запись `server.user.net.` и A-записи для `user.net`, `ns.user.net` и `server.user.net` с адресом `192.168.1.1`, что подтверждает корректную настройку прямой зоны ([рис. @fig-22]).

![Вывод команды host -l для зоны user.net](image/22.png){#fig-22 width=70%}
[рис. 22](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/22.png)

Командой `host -a user.net` выполнен расширенный запрос типа ANY. В разделе ANSWER присутствуют записи SOA, NS и A, что подтверждает корректность параметров зоны и серийного номера ([рис. @fig-23]).
...
[Нажмите здесь, чтобы открыть ссылку.](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/26.png)
...
[Нажмите здесь, чтобы открыть ссылку.](https://github.com/ArsenioPacavira99/study_2025-2026_net-os-admin-12/tree/master/labs/lab02/report/image/27.png)
# Выводы
